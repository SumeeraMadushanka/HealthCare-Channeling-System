...
export default class Home extends Component {
    render() {
        return (
            ...
            <div style={{marginTop:'320px', marginLeft:'290px'}}>
                <table className="table1">
                    ...
                    <tr>
                        ...
                        <td className="td1"><h4 className="hcolor">Patient Info</h4></td>
                        <td><h4 className="hcolor">Payment</h4></td>
                        <td className="td1"><h4 className="hcolor">Surgery</h4></td>
                        <td className="td1"><h4 className="hcolor">Pharmacy</h4></td>
                        <td className="td1"><h4 className="hcolor">Services</h4></td>
                    </tr>
                </table>
            </div>
